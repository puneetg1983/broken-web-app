...
resource appInsightsWebTestHttp500_1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_1'
    }
    ValidationRules: {
      SSLCheck: true
...
resource appInsightsWebTestHttp500_1Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_1-actual'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_2 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_2'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_2Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_2-actual'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_3 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_3'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_3Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_3-actual'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_4 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_4'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_4Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/scenarios/http500/http500_4-actual'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHome 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-home'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-home'
    Name: '${appServiceName}-webtest-home'
    Enabled: true
    Frequency: 300
    Timeout: 30
...
resource appInsightsWebTestProcessMetrics 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-process-metrics'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-process-metrics'
    Name: '${appServiceName}-webtest-process-metrics'
    Enabled: true
    Frequency: 300
    Timeout: 30
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/process-metrics'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100

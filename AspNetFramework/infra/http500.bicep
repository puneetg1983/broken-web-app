...
resource appInsightsWebTestHttp500_1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_1.aspx'
    }
    ValidationRules: {
      SSLCheck: true
...
resource appInsightsWebTestHttp500_1Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_1Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_2 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_2.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_2Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_2Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_3 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_3.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_3Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_3Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestHttp500_4 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/Http500/Http500_4Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors1.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors1Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors1Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors2 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors2.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors2Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors2Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors3 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors3.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestServerErrors3Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/ServerErrors/ServerErrors3Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100

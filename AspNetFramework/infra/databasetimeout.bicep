...
resource appInsightsWebTestSlowDatabase1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/DatabaseTimeout/DatabaseTimeout1.aspx'
    }
    ValidationRules: {
      SSLCheck: true
...
resource appInsightsWebTestSlowDatabase2 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: 'https://${webApp.properties.defaultHostName}/Scenarios/DatabaseTimeout/DatabaseTimeout1Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100

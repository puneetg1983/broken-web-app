...
resource appInsightsWebTestStorageQuota1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: '${webAppUrl}/Scenarios/StorageQuota/StorageQuota1.aspx'
    }
    ValidationRules: {
      SSLCheck: true
...
resource appInsightsWebTestStorageQuota1Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-storagequota-1-actual'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-storagequota-1-actual'
    Name: '${appServiceName}-webtest-storagequota-1-actual'
    Enabled: true
    Frequency: 300
    Timeout: 30

...
param logAnalyticsName string = 'broken-webapps-appinsights-workspace'
...
resource appInsightsWebTestSlowDependency1 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: '${webAppUrl}/Scenarios/SlowDependency/SlowDependency1.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestSlowDependency1Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-slowdependency-1-actual'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-slowdependency-1-actual'
    Name: '${appServiceName}-webtest-slowdependency-1-actual'
    Enabled: true
    Frequency: 300
    Timeout: 30
...
resource appInsightsWebTestSlowDependency2 'Microsoft.Insights/webtests@2022-06-15' = {
  ...
  properties: {
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: '${webAppUrl}/Scenarios/SlowDependency/SlowDependency2.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestSlowDependency2Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-slowdependency-2-actual'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-slowdependency-2-actual'
    Name: '${appServiceName}-webtest-slowdependency-2-actual'
    Enabled: true
    Frequency: 300
    Timeout: 30
...
resource appInsightsWebTestSlowDependency3 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-slowdependency-3'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-slowdependency-3'
    Name: '${appServiceName}-webtest-slowdependency-3'
    Enabled: true
    Frequency: 300
    Timeout: 30
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: '${webAppUrl}/Scenarios/SlowDependency/SlowDependency3.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
...
resource appInsightsWebTestSlowDependency3Actual 'Microsoft.Insights/webtests@2022-06-15' = {
  name: '${appServiceName}-webtest-slowdependency-3-actual'
  location: location
  tags: {
    'hidden-link:${appInsights.id}': 'Resource'
  }
  properties: {
    SyntheticMonitorId: '${appServiceName}-webtest-slowdependency-3-actual'
    Name: '${appServiceName}-webtest-slowdependency-3-actual'
    Enabled: true
    Frequency: 300
    Timeout: 30
    ...
    RetryEnabled: true
    Request: {
      RequestUrl: '${webAppUrl}/Scenarios/SlowDependency/SlowDependency3Actual.aspx'
    }
    ValidationRules: {
      SSLCheck: true
      SSLCertRemainingLifetimeCheck: 100
